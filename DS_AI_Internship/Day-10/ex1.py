...
import pandas as pd
# pandas is a Python library used for data analysis and data cleaning.
# pd is just a shortcut name.


# STEP 2 — Create messy dataset (added Date + messy City + duplicate row)
# Missing values (None),Extra spaces in "City",Duplicate row (CustomerID 107 appears twice),Mixed data types,Date stored as string 
data = {
...
# df.info():Number of rows,Column names,Data types,Non-null count
# if we put 3 inside head braket it will show 3 rows
print("First rows:\n", df.head())
print("\nDataset info:")
print(df.info())
